...
if __name__ == '__main__':
    ...
    para = {'gamma': [0.001, 0.01, 0.1, 1, 10],
            'n_neighbors': [7,8,9,10,11,12]}
    y_c = []
    best_ps = []
    for n in para['n_neighbors']:
        spectre = SpectralClustering(n_clusters=4, random_state=seed, affinity ='nearest_neighbors',
                                     n_neighbors = n).fit(X_scale) # X simple
